...
avatar = media.Movie("Avatar",
                     ...
                     "7.9/10",
                     "Avatar (marketed as James Cameron's Avatar) is a 2009 American epic science fiction film",
                     "James Cameron")
...
jurassicpark = media.Movie("Jurassic Park",
                           ...
                           "8.7/10",
                           "Huge advancements in scientific technology have enabled a mogul to create an island full of living dinosaurs",
                           "Steven Spielberg")
...
titanic = media.Movie("Titanic",
                      ...
                      "7.7/10",
                      "Titanic is a 1997 American epic romantic disaster film. A fictionalized account of the sinking of the RMS Titanic",
                      "James Cameron")
# Instantiate terminator object of Movie class
terminator = media.Movie("Terminator 2",
                         "Science fiction",
                         "http://upload.wikimedia.org/wikipedia/en/6/6b/Terminator-2-shocking-dark-poster.jpg",
                         "https://youtu.be/CAQ83W3DZS4",
                         "8.5/10",
                         "Terminator 2 is a 1991 American science fiction action film","James Cameron")
